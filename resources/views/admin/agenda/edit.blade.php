...
<div class="max-w-3xl mx-auto space-y-8 animate-fade-in">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight font-sans">Ubah Agenda</h1>
            <p class="text-gray-500 mt-1">Lakukan perubahan pada formulir di bawah ini untuk memperbarui data agenda.</p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-3xl border border-gray-150/80 shadow-sm overflow-hidden p-6 sm:p-8">
        <form action="{{ route('admin.agenda.update', $agenda->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6" x-data="{ 
            imagePreview: '{{ $agenda->gambar ? asset($agenda->gambar) : '' }}',
            previewImage(event) {
            ...
            <div>
                ...
                <input type="text" name="nama_kegiatan" id="nama_kegiatan" value="{{ old('nama_kegiatan', $agenda->nama_kegiatan) }}" required 
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_kegiatan" id="tanggal_kegiatan" value="{{ old('tanggal_kegiatan', $agenda->tanggal_kegiatan->format('Y-m-d')) }}" required 
                ...
                <div>
                    ...
                    <input type="text" name="penyelenggara" id="penyelenggara" value="{{ old('penyelenggara', $agenda->penyelenggara) }}" required 
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="lokasi" id="lokasi" value="{{ old('lokasi', $agenda->lokasi) }}" required 
            ...
            <div>
                ...
                <textarea name="agenda" id="agenda" rows="6" required 
                    ...
                    placeholder="Contoh format:&#10;08:00 - 09:00 : Registrasi Peserta&#10;09:00 - 10:00 : Pembukaan & Sambutan&#10;10:00 - selesai : Sesi Seminar Utama">{{ old('agenda', $agenda->agenda) }}</textarea>
                @error('agenda')
                    <p class="mt-2 text-xs text-rose-550 flex items-center gap-1.5 font-medium animate-pulse"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</p>
                @enderror
            </div>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="gambar" class="flex flex-col items-center justify-center w-full h-36 border-2 border-gray-200 border-dashed rounded-2xl cursor-pointer bg-gray-50 hover:bg-gray-100/50 transition-colors">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="text-xs text-gray-500 font-bold mb-1">Klik untuk unggah poster baru</p>
                                    <p class="text-[10px] text-gray-400 uppercase tracking-wider font-semibold">Format: PNG, JPG, JPEG, WEBP (Maksimal 2MB)</p>
                                    <p class="text-[9px] text-gray-400 mt-1">* Biarkan kosong jika tidak ingin mengubah poster</p>
                                </div>
